    ...
    <div class="card">
        <div class="card-header">
            ...
            <div class="card-tools">
                <a href="{{ route('roles.create') }}" class="btn btn-primary"><i class="bi bi-shield-plus"></i> Creer
                    nouveau role</a>
            </div>
        </div>
                    ...
                    <tr>
                        ...
                        <td>
                            @foreach ($role->permissions as $permission )
                                <button class="btn btn-warning" role="button"><i class="bi bi-shield-exclamation"></i> {{ $permission->name }}</button>
                            @endforeach
                        </td>
